...
1. Download the `scrcpy-automation.ps1` script and/or the `scrcpy-config.json` through the [releases page](https://github.com/MNZaidan/scrcpy-automation/releases/latest).
